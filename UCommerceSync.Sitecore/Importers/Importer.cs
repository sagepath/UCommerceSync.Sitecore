...
namespace UCommerceSync.Sitecore.Importers
{
	public class Importer : ImportExportBase, IImporter
	{
		...
		{
			string dateTimeAsString = this.GetPropertyValue(entityXml, propertyName);

			if (string.IsNullOrWhiteSpace(dateTimeAsString))
			{
				dateTimeAsString = "2000-01-01T00:00:00";
			}

			DateTime dateTime = Convert.ToDateTime(dateTimeAsString);
