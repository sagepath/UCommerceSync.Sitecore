app.config(function ($routeProvider) {
	$routeProvider
		...
		.when('/ucommerce/options/marketing/createcampaignitem/:parentId', {
			redirectTo: function (routeParameters) {
			    return buildUrl('marketing/editcampaignitem.aspx?parent=' + routeParameters.parentId);
			}
		})
        ...
        //UCommerceSync
		.when('/ucommerce/uCommerceSync/uCommerceSync.aspx', {
		    redirectTo: function () {
		        return buildUrl('/uCommerceSync/uCommerceSync.aspx');
		    }
		})
        //UCommerceSync Export
		.when('/ucommerce/uCommerceSync/uCommerceSyncExport.aspx', {
		    redirectTo: function () {
		        return buildUrl('/uCommerceSync/uCommerceSyncExport.aspx');
		    }
		})
        //UCommerceSync Import
		.when('/ucommerce/uCommerceSync/uCommerceSyncImport.aspx', {
		    redirectTo: function () {
		        return buildUrl('/uCommerceSync/uCommerceSyncImport.aspx');
		    }
		})
		//Default
		.when('/about:blank', {
